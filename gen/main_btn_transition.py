...
class Button:
    ...
    def update_and_draw(self) -> None:
        ...
        self.is_clicked = False
        if is_hovered and rl.is_mouse_button_pressed(rl.MouseButton.MOUSE_BUTTON_LEFT):
...
def main() -> None:
    ...
    # Level Menu Buttons
    btn_back = Button(300, 250, 200, 50, "BACK", rl.GRAY, rl.MAROON, rl.WHITE)
    btn_lvl1 = Button(300, 320, 200, 50, "CLASSIC MAZE", rl.BLUE, rl.SKYBLUE, rl.WHITE)
    ...
    while not rl.window_should_close():
        ...
        if current_state == STATE_MAIN_MENU:
            ...
            rl.draw_text("SELECT A LEVEL", 220, 100, 40, rl.RAYWHITE)
